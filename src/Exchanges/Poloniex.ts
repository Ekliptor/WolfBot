                ...
                switch (msg[0])
                {
                    ...
                    case 1002: // market updates, ticker
                        ...
                        try {
                            ...
                            logger.error("Error parsing %s ticker", this.className, err);
                        }
                        break;
