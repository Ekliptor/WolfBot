...
botlist=(
     'Sensor1/app.js --config=PoloStops --trader=RealTimeTrader -p=8234'
     'Sensor2/app.js --config=PlanRunner --trader=RealTimeTrader -p=5743'
     'Sensor3/app.js --config=Bitfinex --lending -p=2888'
     'Sensor4/app.js --config=PlanRunnerFutures --trader=RealTimeTrader --paper -p=3392'
     #'Sensor4/app.js --config=FuturesTechnical --trader=RealTimeTrader --paper -p=3392'
     #'Sensor5/app.js --config=Reddit --social -p=2868'
     #'Sensor6/app.js --config=WaveSurfer2KrakenSlow --trader=RealTimeTrader -p=2898'
   )
